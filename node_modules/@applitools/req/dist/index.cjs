...
async function req(input, ...requestOptions) {
  ...
  const timeout = (options === null || options === void 0 ? void 0 : options.timeout) ? setTimeout(() => controller.abort(), options.timeout) : null;
  try {
  ...
  async function req2(input2, options2) {
    ...
    const fetch2 = (_a4 = options2 === null || options2 === void 0 ? void 0 : options2.fetch) !== null && _a4 !== void 0 ? _a4 : fetch;
    if (options2 === null || options2 === void 0 ? void 0 : options2.signal)
      options2.signal.onabort = () => controller.abort();
    const url = new URL(String((_b = input2.url) !== null && _b !== void 0 ? _b : input2), options2 === null || options2 === void 0 ? void 0 : options2.baseUrl);
    if (options2 === null || options2 === void 0 ? void 0 : options2.query) {
    ...
    let request = new Request(url, {
      method: (_c = options2 === null || options2 === void 0 ? void 0 : options2.method) !== null && _c !== void 0 ? _c : input2.method,
      headers: {
        ...Object.fromEntries((_e = (_d2 = input2.headers) === null || _d2 === void 0 ? void 0 : _d2.entries()) !== null && _e !== void 0 ? _e : []),
        ...Object.fromEntries(new Headers(options2 === null || options2 === void 0 ? void 0 : options2.headers).entries())
      },
      body: utils2.types.isPlainObject(options2 === null || options2 === void 0 ? void 0 : options2.body) || utils2.types.isArray(options2 === null || options2 === void 0 ? void 0 : options2.body) || (options2 === null || options2 === void 0 ? void 0 : options2.body) === null ? JSON.stringify(options2 === null || options2 === void 0 ? void 0 : options2.body) : (_f = options2 === null || options2 === void 0 ? void 0 : options2.body) !== null && _f !== void 0 ? _f : input2.body,
    ...
    try {
      ...
      const retry = await ((_g = options2 === null || options2 === void 0 ? void 0 : options2.retry) === null || _g === void 0 ? void 0 : _g.reduce(async (prev, retry2) => {
        var _a5, _b2;
      ...
      const retry = await ((_k = options2 === null || options2 === void 0 ? void 0 : options2.retry) === null || _k === void 0 ? void 0 : _k.reduce((prev, retry2) => {
